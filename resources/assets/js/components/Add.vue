	  ...
	  <div class="modal-card">
	    ...
	    <section class="modal-card-body">
	      ...
	      <div class="field">
	        ...
	        <div class="control">
	          <input class="input" :class="{'is-danger':errors.phone}" type="text" placeholder="Text input" v-model='list.phone'>
	        </div>
...
<script>
	export default{
		...
		methods: {
			...
			save(){
				axios.post('/contact', this.$data.list).then((response) => this.close())
